...
function SignUp() {
    ...
    return (
        <div className='bg-container d-flex justify-content-center align-items-center vh-100'>
            <div className='bg-success p-4 rounded-4 register-card' style={{ opacity: "0.8" }}>
                ...
                <Link to="/login" className='bg-white btn btn-default border w-100 bg-success rounded-0 text-decoration-none' style={{ fontWeight: "600" }}>
                    Login
                </Link>
